...
🎬 **Demo**: Showing off something more advanced so you know what you can use R for in the future.f
...
**[Note: Potentially switch to race/ethnicity to demonstrate that concept]**
...
## 3.8 Fetching census microdata data with `get_pums`
...
As we discussed at the beginning, there are many different types of research questions that census data can help us answer. For this exercise, we're going to replicate this Brookings Institute report on trends in U.S. immigration during the 1990s: \
<https://www.brookings.edu/wp-content/uploads/2016/06/20040301_gateways.pdf>.

This report was published all the way back in 2004, so this could use an update! The original report compared data from the 1990 and 2000 decennial censuses to analyze changes in immigration during the 1990s. For this analysis, let's update the analysis to focus on the 2010s.

Because the decennial census has asked fewer questions since 2010, we'll want to use the American Community Survey. To cover the 2010s, let's compare 2010-2014 5-year estimates with 2015-2019 5-year estimates.

⚠️ **Warning**: When comparing changes over time using 5-year estimates, avoid choosing two periods that overlap. Otherwise, your comparison will be comparing estimates based (at least in part) on the exact same observations!
